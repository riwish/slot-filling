...
from config.global_config import MODEL_OUTPUT_DIR, OUTPUT_PREDICTION_DIR, CUDA_PREF, INPUT_PREDICTION_DIR
from utilities.utils import init_logger, load_tokenizer, get_slot_labels, MODEL_CLASSES_TRANSFORMERS
...
def load_model(pred_config, args, device):
    ...
    try:
        model = MODEL_CLASSES_TRANSFORMERS[args.model_type][1].from_pretrained(args.model_dir,
                                                      args=args,
