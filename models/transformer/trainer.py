...
from utilities.utils import MODEL_CLASSES_TRANSFORMERS, compute_metrics, get_slot_labels, load_knowledge
...
class Trainer(object):
    def __init__(self, args, train_dataset=None, val_dataset=None, test_dataset=None):
        ...
        self.config_class, self.model_class, _ = MODEL_CLASSES_TRANSFORMERS[args.model_type]
        self.config = self.config_class.from_pretrained(args.pretrained_model_path, finetuning_task=args.task)
            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0:
                    ...
                    if self.args.logging_steps > 0 and global_step % self.args.logging_steps == 0:
                        self.evaluate_neural("val", step=global_step)
