...
class TransformerBert(BertPreTrainedModel):
    config_class = BertConfig
    base_model_prefix = "bert"

    def __init__(self, config, args, slot_label_lst):
        super(TransformerBert, self).__init__(config)
        self.args = args
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, slot_labels_ids):
        ...
        return outputs  # (loss), logits, (hidden_states), (attentions) # Logits is a tuple slot logits
